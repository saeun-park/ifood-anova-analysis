# ifood-anova-analysis
iFood 고객 데이터 기반 사치재/일반재 소비 패턴 분석 - 소득, 학력, 자녀 유무 등 인구통계학적 특성이 구매량에 미치는 영향을 ANOVA로 분석
...
![Untitled](images/5result-1.png)

<table>
<tr>
<td width="50%"><img src="images/5result-2.png" width="100%" alt="교호작용"/></td>
